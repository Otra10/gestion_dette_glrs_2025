...
import com.example.views.DemandeDetteView;
...
public class FactoryView implements IFactoryView {
    ...
    public IDetteView getInstanceDette() {
        return detteView == null ? new DetteView(factoryService.getInstanceDetteService(),
                ...
                new PaiementView(factoryService.getInstancePaiementService(),
                        factoryService.getInstanceDetteService(),
                        factoryRepository.getInstanceDetteRepository()),
                factoryService.getInstaDemandeDetteService())
                : detteView;
    }
    ...
    public IDemandeDetteView getInstanceDemandeDetteView() {
        return demandeDetteView == null
                ? new DemandeDetteView(factoryService.getInstaDemandeDetteService(),
                        factoryService.getInstanceArticleService(),factoryService.getInstanceClientService())
                : demandeDetteView;
    }
}
